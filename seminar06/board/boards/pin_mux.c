...
void BOARD_InitPins(void)
{
    ...
    PORT_SetPinMux(BOARD_UART1_TX_PORT, BOARD_UART1_TX_PIN, kPORT_MuxAlt2);

    /* PORTC5 (pin D8) is configured as SPI0_SCK */
    PORT_SetPinMux(BOARD_FB_AD10_PORT, BOARD_FB_AD10_PIN, kPORT_MuxAlt2);
    ...
    PORT_SetPinMux(BOARD_USB_SOF_OUT_PORT, BOARD_USB_SOF_OUT_PIN, kPORT_MuxAlt2);
}
