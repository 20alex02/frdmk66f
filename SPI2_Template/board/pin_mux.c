...
- pin_list:
  ...
  - {pin_num: D4, peripheral: SPI0, signal: SCK, pin_signal: ADC0_SE5b/PTD1/SPI0_SCK/UART2_CTS_b/FTM3_CH1/FB_CS0_b, identifier: '', digital_filter: enable}
  - {pin_num: B4, peripheral: SPI0, signal: SIN, pin_signal: PTD3/SPI0_SIN/UART2_TX/FTM3_CH3/FB_AD3/SDRAM_A11/I2C0_SDA, identifier: '', digital_filter: enable}
  - {pin_num: C4, peripheral: SPI0, signal: SOUT, pin_signal: PTD2/LLWU_P13/SPI0_SOUT/UART2_RX/FTM3_CH2/FB_AD4/SDRAM_A12/I2C0_SCL, identifier: '', digital_filter: enable}
  - {pin_num: A5, peripheral: SPI0, signal: PCS0_SS, pin_signal: PTD0/LLWU_P12/SPI0_PCS0/UART2_RTS_b/FTM3_CH0/FB_ALE/FB_CS1_b/FB_TS_b, identifier: '', digital_filter: enable}
...
void BOARD_InitPins(void)
{
    ...
    PORT_SetPinMux(BOARD_PTB10_RC_PORT, BOARD_PTB10_RC_PIN, kPORT_MuxAlt3);

    /* PORTB11 (pin E11) is configured as UART3_TX */
    PORT_SetPinMux(BOARD_PTB11_RC_PORT, BOARD_PTB11_RC_PIN, kPORT_MuxAlt3);
