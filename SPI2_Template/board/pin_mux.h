...
/* Symbols to be used with PORT driver */
#define BOARD_PTB11_RC_PORT PORTB                /*!<@brief PORT peripheral base pointer */
#define BOARD_PTB11_RC_PIN 11U                   /*!<@brief PORT pin number */
#define BOARD_PTB11_RC_PIN_MASK (1U << 11U)      /*!<@brief PORT pin mask */
                                                 /* @} */
...
/* Symbols to be used with PORT driver */
#define BOARD_PTB10_RC_PORT PORTB                /*!<@brief PORT peripheral base pointer */
#define BOARD_PTB10_RC_PIN 10U                   /*!<@brief PORT pin number */
#define BOARD_PTB10_RC_PIN_MASK (1U << 10U)      /*!<@brief PORT pin mask */
                                                 /* @} */
