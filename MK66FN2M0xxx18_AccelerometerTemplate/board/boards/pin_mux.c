...
- pin_list:
  ...
  - {pin_num: B9, peripheral: I2C0, signal: SDA, pin_signal: PTD9/I2C0_SDA/LPUART0_TX/FB_A17, identifier: ACCEL_SDA, slew_rate: fast, open_drain: enable, pull_select: up,
  ...
  - {pin_num: D5, peripheral: GPIOC, signal: 'GPIO, 17', pin_signal: PTC17/CAN1_TX/UART3_TX/ENET0_1588_TMR1/FB_CS4_b/FB_TSIZ0/FB_BE31_24_BLS7_0_b/SDRAM_DQM3, direction: INPUT,
    gpio_interrupt: kPORT_InterruptFallingEdge, slew_rate: fast, open_drain: disable, pull_select: up}
  - {pin_num: D6, peripheral: GPIOC, signal: 'GPIO, 13', pin_signal: PTC13/UART4_CTS_b/FTM_CLKIN1/FB_AD26/SDRAM_D26/TPM_CLKIN1, direction: INPUT, gpio_interrupt: kPORT_InterruptFallingEdge,
    slew_rate: fast, open_drain: disable, pull_select: up, pull_enable: disable}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitACCEL_I2CPins(void)
{
    ...
    /* Interrupt configuration on PORTC13 (pin D6): Interrupt on falling edge */
    PORT_SetPinInterruptConfig(BOARD_ACCEL_INT2_PORT, BOARD_ACCEL_INT2_PIN, kPORT_InterruptFallingEdge);
    ...
    /* Interrupt configuration on PORTC17 (pin D5): Interrupt on falling edge */
    PORT_SetPinInterruptConfig(BOARD_ACCEL_INT1_PORT, BOARD_ACCEL_INT1_PIN, kPORT_InterruptFallingEdge);
