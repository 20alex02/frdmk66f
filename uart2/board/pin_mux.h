...
/* Symbols to be used with PORT driver */
#define BOARD_UART1_TX_PORT PORTC               /*!<@brief PORT peripheral base pointer */
#define BOARD_UART1_TX_PIN 4U                   /*!<@brief PORT pin number */
#define BOARD_UART1_TX_PIN_MASK (1U << 4U)      /*!<@brief PORT pin mask */
                                                /* @} */
